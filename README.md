...
<img src="https://user-images.githubusercontent.com/74038190/212284100-561aa473-3905-4a80-b561-0d28506553ee.gif" width="500" alt="Animação de programação">
...
Atuo na criação de aplicações **web e full stack**, trabalhando com interfaces responsivas, APIs, bancos de dados e integrações com serviços externos. Também exploro áreas como **inteligência artificial** e **visão computacional**.
...
`Python` `Visão computacional` `Detecção facial`
